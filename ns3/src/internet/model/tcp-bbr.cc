...
TcpBbr::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::TcpBbr")
            ...
            .AddTraceSource("RtPropRaw",
                            "Raw RTT sample considered for RTprop update",
                            MakeTraceSourceAccessor(&TcpBbr::m_rtpropRaw),
                            "ns3::TracedValueCallback::Time")
            .AddTraceSource("BtlBwRaw",
                            "Raw delivery-rate sample considered for BtlBw update",
                            MakeTraceSourceAccessor(&TcpBbr::m_btlBwRaw),
...
TcpBbr::UpdateBottleneckBandwidth(Ptr<TcpSocketState> tcb, const TcpRateOps::TcpRateSample& rs)
{
    ...
    m_btlBwRaw = rs.m_deliveryRate.GetBitRate();
...
const TcpBbr::MaxBandwidthFilter_t&
TcpBbr::GetMaxBwFilter() const
{
    NS_LOG_FUNCTION(this);
    return m_maxBwFilter;
}

Time
TcpBbr::GetMinRtt() const
{
    NS_LOG_FUNCTION(this);
    return m_minRtt;
}
